...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'pis', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-02-15T23:36:44.500Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('adepte meuh');
      cy.get(`[data-cy="title"]`).should('have.value', 'adepte meuh');
      ...
      cy.get(`[data-cy="date"]`).type('2024-02-15T20:50');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-02-15T20:50');
