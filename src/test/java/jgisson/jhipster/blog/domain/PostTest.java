...
import static jgisson.jhipster.blog.domain.BlogTestSamples.*;
import static jgisson.jhipster.blog.domain.PostTestSamples.*;
import static jgisson.jhipster.blog.domain.TagTestSamples.*;
import static org.assertj.core.api.Assertions.assertThat;

import java.util.HashSet;
import java.util.Set;
import jgisson.jhipster.blog.web.rest.TestUtil;
