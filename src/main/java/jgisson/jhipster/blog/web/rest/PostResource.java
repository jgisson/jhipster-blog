...
import jgisson.jhipster.blog.repository.PostRepository;
...
/**
 * REST controller for managing {@link jgisson.jhipster.blog.domain.Post}.
 */
@RestController
...
public class PostResource {
    ...
    public ResponseEntity<Post> updatePost(@PathVariable(value = "id", required = false) final String id, @Valid @RequestBody Post post)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, post.getId()))
            .body(result);
    }
