...
import jgisson.jhipster.blog.repository.TagRepository;
...
/**
 * REST controller for managing {@link jgisson.jhipster.blog.domain.Tag}.
 */
@RestController
...
public class TagResource {
    ...
    public ResponseEntity<Tag> updateTag(@PathVariable(value = "id", required = false) final String id, @Valid @RequestBody Tag tag)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tag.getId()))
            .body(result);
    }
