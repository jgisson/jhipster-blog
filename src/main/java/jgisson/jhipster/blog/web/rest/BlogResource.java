...
/**
 * REST controller for managing {@link jgisson.jhipster.blog.domain.Blog}.
 */
@RestController
...
public class BlogResource {
    ...
    public ResponseEntity<Blog> updateBlog(@PathVariable(value = "id", required = false) final String id, @Valid @RequestBody Blog blog)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, blog.getId()))
            .body(result);
    }
